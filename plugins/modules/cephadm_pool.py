...
options:
    ...
    image:
        description:
            - Container image used to run cephadm/ceph commands.
        required: false
        type: str
    fsid:
        description:
            - Ceph cluster FSID used to target the correct cluster.
        required: false
        type: str
    hostname:
        description:
            - Hostname passed to cephadm to run commands on a specific host.
        required: false
        type: str
'''
